...
import { ArrowLeft, ArrowRight, Check, Calendar as CalendarIcon, Clock, User, Scissors, ChevronLeft, ChevronRight } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { Link } from 'react-router-dom';
import { services, barbers, generateTimeSlots, Service, Barber, TimeSlot, shopInfo } from '@/lib/data';
...
const Booking = () => {
  ...
  const canProceed = () => {
    switch (currentStep) {
      ...
      case 5: return clientName.length > 2 && clientPhone.length > 8;
        ...
        <div className="pt-24 pb-12 px-4">
          <div className="container-narrow max-w-lg mx-auto">
            ...
            >
              ...
              <p className="text-muted-foreground mb-6">Você está na fila de espera</p>
              ...
              {queuePosition && (
                <div className="bg-secondary rounded-2xl p-6 mb-6">
                  ...
                  <p className="text-sm text-muted-foreground mt-2">
                    Estimativa: ~{queuePosition * 15} minutos
                  </p>
                </div>
              )}

              <div className="space-y-3 text-left bg-secondary/50 rounded-xl p-4 mb-6">
          ...
          <div className="fixed bottom-0 left-0 right-0 bg-background/95 backdrop-blur-lg border-t border-border p-4 md:relative md:mt-8 md:p-0 md:border-0 md:bg-transparent">
            <div className="flex gap-3 max-w-2xl mx-auto">
              ...
              <Button
                ...
                className="flex-1"
              >
                {currentStep === 5 ? 'Confirmar' : 'Continuar'}
